...
const LoginForm = () => {
    return (
        <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0 bg-[#DEF2F1]">
                <div className="md:w-1/3 max-w-2xl">
                    ...
                    <div className="text-center md:text-left">
                        <div className="flex justify-center">
                            <button className="btn btn-active btn-ghos bg-[#3AAFA9] mt-5 w-2/3 px-1" >Sign in</button>
                        </div>
                    </div>
                </div>
